...
public class ExternalServiceRegistrationService {
    ...
    @Transactional
    public com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service registerExternalService(
        ...
        com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service = serviceRepository
                .findByName(registration.getServiceName())
                .orElse(new com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service());
    ...
    private void storeOperations(com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service,
    ...
    private void storeMetadata(com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service,
    ...
    private void storeHostedServices(com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service,
    ...
    public boolean updateHeartbeat(String serviceName) {
        ...
        Optional<com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service> serviceOpt = serviceRepository
                .findByName(serviceName);

        if (serviceOpt.isPresent()) {
            com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service = serviceOpt.get();
    ...
    public List<com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service> getAllActiveServices() {
        return serviceRepository.findByStatus("ACTIVE");
    }

    public Optional<com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service> findServiceByOperation(String operation) {
    ...
    public List<Map<String, Object>> getAllServicesWithHosted() {
        ...
        List<com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service> services = serviceRepository.findByStatus("ACTIVE");
        List<Map<String, Object>> result = new java.util.ArrayList<>();

        for (com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service service : services) {
