...
public class ServiceResponseBody implements Serializable {
    ...
    /**
     * Convert from legacy ServiceResponse to v1 ServiceResponseBody.
     */
    @SuppressWarnings("unchecked")
    public static ServiceResponseBody fromLegacy(com.angrysurfer.spring.nexus.broker.api.ServiceResponse<?> legacy) {
    ...
    /**
     * Convert from v1 ServiceResponseBody to legacy ServiceResponse.
     */
    @SuppressWarnings("unchecked")
