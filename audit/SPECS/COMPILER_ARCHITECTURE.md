...
|---|---|
| [`WORKREQUEST_SPEC.md`](./WORKREQUEST_SPEC.md) | WorkRequest IR — the canonical intermediate representation |
| [`PHASE1_SPECIFICATION_COMPILER.md`](./PHASE1_SPECIFICATION_COMPILER.md) | Phase 1 full specification (Prompt → WorkRequestGraph) |
| [`LOWERING_PASS.md`](./LOWERING_PASS.md) | Phase 1.5 full specification (WorkRequestGraph → ExecutionGraph) |
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph IR — the runtime AST schema |
| [`PHASE2_EXECUTION_RUNTIME.md`](./PHASE2_EXECUTION_RUNTIME.md) | Phase 2 full specification (ExecutionGraph → EventLog) |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | ExecutionGraph Validator — four-dimension validation |
| [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) | Distributed scheduler for multi-node execution |
| [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) | Temporal AST interpreter for state reconstruction |
| [`OBSERVATION_MODEL.md`](./OBSERVATION_MODEL.md) | Phase 3 — semantic projection over execution history |
| [`EVENT_GRAMMAR.md`](./EVENT_GRAMMAR.md) | Event type taxonomy and causal grammar |
| [`CER_SPEC.md`](./CER_SPEC.md) | Canonical Event Record format |
| [`CER_CCNF.md`](./CER_CCNF.md) | CER Canonical Normalization Function |
| [`CER_SNAPSHOT_ENGINE.md`](./CER_SNAPSHOT_ENGINE.md) | Snapshot Engine for compressed state materialization |
| [`PIPELINE_INTENT_SPEC.md`](./PIPELINE_INTENT_SPEC.md) | Pipeline intent declaration and routing model |
| [`AUTHORITY_GRAPH_IR.md`](./AUTHORITY_GRAPH_IR.md) | Authority Graph for AEI validation |
...
See [`PHASE1_SPECIFICATION_COMPILER.md`](./PHASE1_SPECIFICATION_COMPILER.md) for the full specification. See also [`WORKREQUEST_SPEC.md`](./WORKREQUEST_SPEC.md) for the WorkRequest IR definition.
...
See [`LOWERING_PASS.md`](./LOWERING_PASS.md) for the full specification. See also [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) for the output IR schema and [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) for the static validation rules (S1–S10) applied before freeze.
...
See [`PHASE2_EXECUTION_RUNTIME.md`](./PHASE2_EXECUTION_RUNTIME.md) for the full specification. See also [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) for multi-node scheduling and [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) for temporal state reconstruction.
...
See [`EVENT_GRAMMAR.md`](./EVENT_GRAMMAR.md) for the full event grammar, type system, and structural rules. See [`CER_SPEC.md`](./CER_SPEC.md) for the Canonical Event Record format and [`CER_CCNF.md`](./CER_CCNF.md) for the normalization function that guarantees identity stability.
