...
/**
 * Represents a library type for organizing libraries
...
public class LibraryType {
    ...
    public LibraryType(Long id, String name, String description, Boolean activeFlag, LocalDateTime createdAt,
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof LibraryType))
            return false;
        LibraryType that = (LibraryType) o;
