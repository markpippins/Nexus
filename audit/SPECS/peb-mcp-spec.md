...
|---|---|
| [`peb-spring-boot-spec.md`](./peb-spring-boot-spec.md) | Implementation spec — derives from this architecture document |
| [`Understanding Nexus PEB Structure.md`](./Understanding%20Nexus%20PEB%20Structure.md) | Exploratory overview of PEB directory structure |
| [`ANALYSIS.md`](./ANALYSIS.md) §4 | PEB section — aspirational long-term memory layer for WorkRequest pipeline |
| [`cognitive-integrity-rule-system.md`](./cognitive-integrity-rule-system.md) | CIRS — governs PEB governance decisions, Merkle hash use (CIRS-MED), proof integrity (CIRS-SPoE) |
| [`atten-spec.md`](./atten-spec.md) | Atten — PEB validates committed canonical state transitions, not Atten's candidate projections |
