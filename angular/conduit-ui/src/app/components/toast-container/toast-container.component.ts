...
@Component({
  ...
  template: `<div class="toast-stack">
    @for (t of toasts(); track t.id) {
      <div class="toast-card" [ngClass]="'toast-' + t.priority" (click)="dismiss(t.id)">
