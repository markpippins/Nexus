...
|---|---|
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph IR — the frozen AST consumed by this runtime |
| [`LOWERING_PASS.md`](./LOWERING_PASS.md) | Phase 1.5 — produces the frozen ExecutionGraph consumed here |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | Runtime validation (R1–R10) applied during scheduler tick loop |
| [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) | Multi-node scheduler extension |
| [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) | Temporal reconstruction from execution event stream |
