...
The Work Request Pipeline (WRP) Daemon is the operational runtime substrate that bridges theoretical governance and actual execution. It watches a target project's `.pipeline/WORK_REQUESTS/queued/` directory, bounds the work to a specific executor, and automatically triggers the code generation or mutation.
