/**
 * tools-aggregator — command-router DSL parser.
 *
 * Folded in from slash-command-mcp (D-2026-08-16-002). Grammar
 * (line-oriented, single command string):
 *
...
/** Normalize a service token: strip leading "/" — trailing "-mcp" is NOT stripped (keep as-is for matching). */
