...
tool_count = len([t for t in dir() if t.startswith("rover_")])
print(f"rover tools found: {tool_count}")

# Test 2: unknown job_id
print("\n=== Test 2: Unknown job_id ===")
result = json.loads(rover_get_pending_chunk("bad-id"))
...
result = json.loads(rover_get_pending_chunk(job_id))
