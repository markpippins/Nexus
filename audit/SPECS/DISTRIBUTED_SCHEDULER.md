...
|---|---|
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph IR — the AST consumed by the scheduler |
| [`PHASE2_EXECUTION_RUNTIME.md`](./PHASE2_EXECUTION_RUNTIME.md) | Single-host execution runtime — this extends it to multi-host |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | Runtime validation (R2, R3, R8) for distributed safety |
| [`CER_SPEC.md`](./CER_SPEC.md) | Canonical Event Record — state derivation via CER event log |
| [`CER_CCNF.md`](./CER_CCNF.md) | Normalization — entity_key provides globally stable identity across hosts |
| [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) | Replay integration for distributed event logs |
