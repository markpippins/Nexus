...
public class OperatingSystemController {
    ...
    public OperatingSystemController(OperatingSystemRepository repository) {
        this.repository = repository;
    }

    @GetMapping
    public ResponseEntity<com.aibizarchitect.nexus.v1.dto.PagedResponse<OperatingSystem>> getAll(
        ...
        return ResponseEntity.ok(com.aibizarchitect.nexus.v1.spring.serviceregistry.dto.SpringPagedResponse.fromPage(operatingSystems));
    }
