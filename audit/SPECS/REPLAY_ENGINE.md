...
|---|---|
| [`CER_SPEC.md`](./CER_SPEC.md) | Canonical Event Record format — the event schema consumed by replay |
| [`CER_CCNF.md`](./CER_CCNF.md) | Normalization function — ensures identity stability during rehydration |
| [`CER_SNAPSHOT_ENGINE.md`](./CER_SNAPSHOT_ENGINE.md) | Snapshot Engine — derived compression artifacts for fast replay start |
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph state reconstructed by replay |
| [`OBSERVATION_MODEL.md`](./OBSERVATION_MODEL.md) | Phase 3 — consumes replay output for semantic projection |
| [`EVENT_GRAMMAR.md`](./EVENT_GRAMMAR.md) | Event type taxonomy — replay handles all domain event types |
| [`COMPILER_ARCHITECTURE.md`](./COMPILER_ARCHITECTURE.md) | Four-phase architecture — replay is the Observation Layer foundation |
| [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) | Replay integration for distributed event logs |
