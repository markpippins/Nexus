package com.aibizarchitect.nexus.v1.spring.losm;
...
/**
 * Four-path coverage test suite for LosmHostServiceApplication.
 *
 * <p>The losm-host-service is a CRITICAL governance runtime. Currently it is a
 ...
 */
@DisplayName("LosmHostServiceApplication")
class LosmHostServiceApplicationTests {
    ...
    class GreenPath {
        ...
        @Test
        @DisplayName("Application name is set to losm-host-service")
        void applicationNameIsSet() {
            assertEquals("losm-host-service",
                    environment.getProperty("spring.application.name"),
                    "Application name must match the configured value");
        }

        @Test
        @DisplayName("LosmHostServiceApplication bean is registered in context")
        void applicationBeanIsRegistered() {
            assertNotNull(applicationContext.getBean(LosmHostServiceApplication.class),
    ...
    class OrangePath {
        ...
        void onlySkeletonApplicationBeanIsUserDefined() {
            LosmHostServiceApplication app =
                    applicationContext.getBean(LosmHostServiceApplication.class);
            assertNotNull(app,
    ...
    class RedPath {
        ...
        private final ApplicationContextRunner runner =
                new ApplicationContextRunner()
                        .withUserConfiguration(LosmHostServiceApplication.class);
    ...
    class SilentFailure {
        ...
        void springBootApplicationAnnotationIsPresent() {
            SpringBootApplication annotation = LosmHostServiceApplication.class
                    .getAnnotation(SpringBootApplication.class);
            assertNotNull(annotation,
                    "LosmHostServiceApplication must be annotated with @SpringBootApplication. "
        ...
        void applicationPackageIsCorrect() {
            String packageName = LosmHostServiceApplication.class.getPackageName();
            assertEquals("com.aibizarchitect.nexus.v1.spring.losm", packageName,
        ...
        void mainMethodIsCallable() throws Exception {
            var mainMethod = LosmHostServiceApplication.class
