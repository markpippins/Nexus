...
|---|---|
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph IR — the graph being validated |
| [`LOWERING_PASS.md`](./LOWERING_PASS.md) | Phase 1.5 — calls `validate_static()` before freeze |
| [`PHASE2_EXECUTION_RUNTIME.md`](./PHASE2_EXECUTION_RUNTIME.md) | Phase 2 — calls `validate_runtime()` during scheduler tick loop |
| [`CER_SPEC.md`](./CER_SPEC.md) | V12 — CER validation rules for event log consistency |
| [`CER_CCNF.md`](./CER_CCNF.md) | Normalization function — identity stability for validation |
| [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) | Runtime validation in distributed scheduling (R2, R3, R8) |
| [`COMPILER_ARCHITECTURE.md`](./COMPILER_ARCHITECTURE.md) | Four-phase architecture — validator is a cross-cutting component |
| [`AUTHORITY_GRAPH_IR.md`](./AUTHORITY_GRAPH_IR.md) | Authority Graph — AEI validation dimensions (AEI1–AEI4) |
