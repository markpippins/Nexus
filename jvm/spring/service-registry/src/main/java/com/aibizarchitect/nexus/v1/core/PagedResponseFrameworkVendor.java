...
public final class PagedResponseFrameworkVendor implements JsonSerializable<PagedResponseFrameworkVendor> {
    /*
     * The data property.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final List<FrameworkVendor> data;
    ...
    /**
     * Creates an instance of PagedResponseFrameworkVendor class.
     * 
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private PagedResponseFrameworkVendor(List<FrameworkVendor> data, long totalElements, int totalPages, int number,
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public List<FrameworkVendor> getData() {
        return this.data;
    }
    ...
    /**
     * Reads an instance of PagedResponseFrameworkVendor from the JsonReader.
     * 
     * @param jsonReader The JsonReader being read.
     * @return An instance of PagedResponseFrameworkVendor if the JsonReader was pointing to an instance of it, or null
     * if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the PagedResponseFrameworkVendor.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public static PagedResponseFrameworkVendor fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            List<FrameworkVendor> data = null;
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("data".equals(fieldName)) {
                    data = reader.readArray(reader1 -> FrameworkVendor.fromJson(reader1));
            ...
            return new PagedResponseFrameworkVendor(data, totalElements, totalPages, number, numberOfElements, size);
        });
    }
}
