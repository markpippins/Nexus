...
public class ServiceSyncService {
    ...
    private final com.aibizarchitect.nexus.v1.spring.serviceregistry.repository.ServiceTypeRepository serviceTypeRepository;
    ...
    public ServiceSyncService(ServiceRepository serviceRepository,
                              com.aibizarchitect.nexus.v1.spring.serviceregistry.repository.ServiceTypeRepository serviceTypeRepository,
    ...
    private void processRegistrations(List<ServiceRegistration> registrations) {
        ...
        for (ServiceRegistration reg : registrations) {
            try {
                ...
                Optional<com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service> existingOpt =
                ...
                if (existingOpt.isPresent()) {
                    ...
                    service = new com.aibizarchitect.nexus.v1.spring.serviceregistry.entity.Service();
