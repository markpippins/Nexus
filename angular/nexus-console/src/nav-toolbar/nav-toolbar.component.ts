...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    label: 'Assembly',
    title: 'Assembly',
    iconPath: 'M2.25 21h19.5M3.75 21V8.25a1.5 1.5 0 011.5-1.5h2.25a1.5 1.5 0 011.5 1.5V21M9.75 21V12.75a1.5 1.5 0 011.5-1.5h2.25a1.5 1.5 0 011.5 1.5V21m6.75-12.75V21',
  },
  {
    key: 'kanban',
    label: 'Operations',
