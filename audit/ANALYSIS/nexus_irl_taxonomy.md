...
> **Companion document:** See [`nexus_interaction_taxonomy.md`](./nexus_interaction_taxonomy.md) for the IR-side deterministic interaction archetypes (9 closed-contract archetypes). This document defines the IRL-side probabilistic archetypes (8). Together they form two layers of the same three-layer system: IRL (this document) classifies intent probabilistically, the Structural Compiler consumes those labels deterministically, and the Execution Eligibility Gate enforces action policy.
