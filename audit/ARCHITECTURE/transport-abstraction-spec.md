...
|---|---|
| [`messagebox-core-architecture.md`](./messagebox-core-architecture.md) | Core contract — this spec implements the TransportProvider/LedgerProvider split |
| [`message-semantic-taxonomy.md`](./message-semantic-taxonomy.md) | Semantic subject naming convention mapped to transport subjects |
| [`steward-spec.md`](./steward-spec.md) | Steward consumes proposals through the transport abstraction |

> **Related:** [`ENGINEERING/reports/NATS_CASCADE_INTEGRATION_STATUS.md`](../ENGINEERING/reports/NATS_CASCADE_INTEGRATION_STATUS.md) assesses the current NATS implementation status.
