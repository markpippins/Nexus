...
from parsers import chatgpt_parser, copilot_parser, markdown_parser  # noqa: F401

def collect_stats(filepath: Path) -> dict:
    """Run the pipeline on one transcript and extract structural stats."""
    # Import parsers once at module level
    ...
    messages, meta = detect_and_parse(soup, filepath)
