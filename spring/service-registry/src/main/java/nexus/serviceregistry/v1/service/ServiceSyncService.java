...
public class ServiceSyncService {
    ...
    private final nexus.serviceregistry.v1.repository.ServiceTypeRepository serviceTypeRepository;
    ...
    public ServiceSyncService(ServiceRepository serviceRepository,
                              nexus.serviceregistry.v1.repository.ServiceTypeRepository serviceTypeRepository,
    ...
    private void processRegistrations(List<ServiceRegistration> registrations) {
        ...
        nexus.serviceregistry.v1.entity.ServiceType restApiType =
        ...
        for (ServiceRegistration reg : registrations) {
            try {
                ...
                Optional<nexus.serviceregistry.v1.entity.Service> existingOpt =
                ...
                if (existingOpt.isPresent()) {
                    ...
                    service = new nexus.serviceregistry.v1.entity.Service();
