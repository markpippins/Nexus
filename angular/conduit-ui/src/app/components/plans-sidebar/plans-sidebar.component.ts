...
@Component({
  ...
  styles: [
    ...
    `.sidebar-header{display:flex;align-items:center;justify-content:space-between;padding:0 12px;height:48px;border-bottom:1px solid var(--border-subtle,#334155);flex-shrink:0}`,
    `.header-title{font-size:13px;font-weight:600;color:var(--text-primary,#f1f5f9)}`,
