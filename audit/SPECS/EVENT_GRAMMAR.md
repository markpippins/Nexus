...
|---|---|
| [`CER_SPEC.md`](./CER_SPEC.md) | Canonical Event Record format — all events are stored as CER |
| [`CER_CCNF.md`](./CER_CCNF.md) | Normalization function — canonical normalization for all events |
| [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) | Ephemeral observation events emitted by replay (§7) |
| [`EXECUTION_GRAPH_SCHEMA.md`](./EXECUTION_GRAPH_SCHEMA.md) | ExecutionGraph events (Created, Completed) |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | ValidationFailure events and F-class taxonomy |
| [`OBSERVATION_MODEL.md`](./OBSERVATION_MODEL.md) | Phase 3 — observation views derived from typed events |
| [`ARCHITECTURE/message-semantic-taxonomy.md`](./ARCHITECTURE/message-semantic-taxonomy.md) | Parallel semantic role classification for MessageBox messages |
