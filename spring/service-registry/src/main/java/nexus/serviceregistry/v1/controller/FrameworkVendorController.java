...
public class FrameworkVendorController {
    ...
    @GetMapping
    public ResponseEntity<com.angrysurfer.nexus.dto.PagedResponse<FrameworkVendor>> getAll(org.springframework.data.domain.Pageable pageable) {
        ...
        return ResponseEntity.ok(nexus.serviceregistry.v1.dto.SpringPagedResponse.fromPage(vendors));
    }
