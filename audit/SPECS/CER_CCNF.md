...
|---|---|
| [`CER_SPEC.md`](./CER_SPEC.md) | Canonical Event Record format — the output schema of this normalization function |
| [`CER_SNAPSHOT_ENGINE.md`](./CER_SNAPSHOT_ENGINE.md) | Snapshot Engine consuming normalized CER events |
| [`CCNF_FAILURE_MODES.md`](./CCNF_FAILURE_MODES.md) | Failure mode analysis for normalization drift |
| [`EVENT_GRAMMAR.md`](./EVENT_GRAMMAR.md) | Event type taxonomy — CER absorbs and extends these definitions |
