...
public class LibraryCategoryController {
    ...
    public ResponseEntity<?> getLibraryCategories(
        ...
        if (name != null) {
            ...
            return ResponseEntity.ok(com.aibizarchitect.nexus.v1.spring.serviceregistry.dto.SpringPagedResponse.fromPage(libraryCategoryRepository.findAll(pageable)));
        }
    }
