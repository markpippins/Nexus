...
description: Maps intent to a modification of a single file
---

## Rules
- must produce exactly one WorkRequest
- resources must include exactly one target file
- task must be atomic modification