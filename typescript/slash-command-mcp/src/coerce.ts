/**
 * slash-command-mcp — schema-driven argument coercion + validation.
 *
 * Takes the raw string args from the DSL parser and coerces each value
 * against the registered param_schema (from mcp.command_registry.param_schema).
 * Rejects unknown flags, missing required params, and type mismatches with
 * structured errors (never 500s).
 */
