...
### nexus/jvm/spring/topology-server/
...
## Backend: topology-server (`jvm/spring/topology-server/`)
...
ALTERNATIVE - rename table, leave code as is
...
ALTERNATIVE - rename endpoint, leave code as is, fix caller in nexus-console-ui
---
...
ALTERNATIVE - eliminate and replace with call to topology server 
