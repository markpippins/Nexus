...
public class EnvironmentTypeController {
    ...
    @GetMapping
    public ResponseEntity<com.aibizarchitect.nexus.v1.dto.PagedResponse<EnvironmentType>> getAll(org.springframework.data.domain.Pageable pageable) {
        ...
        return ResponseEntity.ok(com.aibizarchitect.nexus.v1.spring.serviceregistry.dto.SpringPagedResponse.fromPage(environmentTypes));
    }
