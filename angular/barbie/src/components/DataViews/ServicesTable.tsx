...
export const ServicesTable: React.FC<ServicesTableProps> = ({
  ...
  // changes (page/size/filter/sort/search) and the initial mount still show
  // the loading row because the data context genuinely changed.
  ...
  useEffect(() => {
    ...
    // sort/search). On a pure refresh we update in place (no loading row, no
    // table blank-out); on a context change we show the loading row.
    const context = JSON.stringify([page, size, searchQuery, statusFilter, selectedSystemFilter, envFilter, sortBy, sortOrder]);
