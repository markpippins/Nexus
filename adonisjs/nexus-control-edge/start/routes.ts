...
router.group(() => {
  ...
  router.get('/config/failure-recovery/conduit', [() => import('#controllers/conduit_controller'), 'getConduitFailureRecovery'])
  router.post('/config/failure-recovery/conduit', [() => import('#controllers/conduit_controller'), 'saveConduitFailureRecovery'])
