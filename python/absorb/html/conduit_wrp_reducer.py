...
def receipt_to_wrp_state(receipt_type: str) -> str:
    return _RECEIPT_TO_WRP.get(receipt_type, "CREATED")
...
_WRP_ADJACENCY_MATRIX: dict = {
    ...
    "SPECIFICATION": {"CRITIQUE": True, "APPROVED": True, "FAILED": True},
    "APPROVED":      {"SPECIFICATION": True, "QUEUED": True, "FAILED": True},
    "QUEUED":        {"EXECUTING": True, "FAILED": True},
...
def is_valid_transition(from_state: str, to_state: str) -> bool:
    return _WRP_ADJACENCY_MATRIX.get(from_state, {}).get(to_state, False) is True
...
from crossref_taxonomy import CrossReferenceType as _CRType
