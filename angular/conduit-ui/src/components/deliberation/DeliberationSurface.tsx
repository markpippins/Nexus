    ...
    <div className="p-4 md:p-6 space-y-6 max-w-[1600px] mx-auto text-zinc-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-mono font-bold uppercase text-zinc-400 tracking-wider">
          ...
          <div className="space-y-2">
            {agendas.map((agenda) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between font-mono text-sm mb-1.5">
        ...
        {activeAgenda ? (
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 space-y-4 shadow-lg">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="bg-emerald-950/80 border border-emerald-600/50 text-emerald-300 text-sm font-mono font-bold px-3 py-1 rounded flex items-center gap-1.5">
                  ...
                  {activeAgenda.status === 'CONSENSUS_REACHED' && (
                    <button
                      ...
                      className="px-3 py-1 bg-emerald-600 hover:bg-emerald-500 text-white font-mono text-sm font-bold rounded flex items-center gap-1 transition-all shadow-md"
                    >
              ...
              {activeAgenda.summaryOutput && (
                <div className="bg-zinc-950 p-3 rounded border border-zinc-800/80 text-sm text-emerald-300 font-mono">
                  💡 {activeAgenda.summaryOutput}
                </div>
              )}
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-mono font-bold uppercase text-zinc-400 tracking-wider flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {activeAgenda.participants.map((part) => (
                    ...
                    >
                      ...
                      {part.comments ? (
                        <p className="text-sm text-zinc-300 italic">"{part.comments}"</p>
                      ) : (
                        <p className="text-sm text-zinc-500 italic">Awaiting vote response...</p>
                      )}
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-mono font-bold uppercase text-zinc-400 tracking-wider">
                  Deliberation Discussion Transcript
                </h3>

                <div className="bg-zinc-950 rounded-lg p-3 border border-zinc-800 max-h-56 overflow-y-auto space-y-2.5 font-mono text-sm">
              ...
              <form onSubmit={handleVoteSubmit} className="bg-zinc-950 p-4 rounded-lg border border-zinc-800 space-y-3">
                <h4 className="text-sm font-mono font-bold uppercase text-zinc-300 flex items-center gap-1.5">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-zinc-900 border border-zinc-700 rounded p-2 text-sm text-zinc-200 outline-none font-sans"
                  />
                  <button
                    type="submit"
                    className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-mono text-sm font-bold rounded flex items-center gap-1 transition-all"
                  >
          ...
          <div className="lg:col-span-2 bg-zinc-900/60 border border-zinc-800 rounded-lg p-12 text-center text-zinc-500 font-mono text-sm">
