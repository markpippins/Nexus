package nexus.serviceregistry.v1.client;

import nexus.serviceregistry.v1.entity.*;
import nexus.serviceregistry.v1.repository.*;
...
public class ServicesConsoleClient {
    ...
    // --- Services ---
    public List<nexus.serviceregistry.v1.entity.Service> getServices() {
        log.info("Fetching all services from database");
        return serviceRepository.findAll();
    }

    public Optional<nexus.serviceregistry.v1.entity.Service> findServiceByName(String name) {
