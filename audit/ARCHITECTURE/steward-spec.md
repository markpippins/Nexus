...
|---|---|
| [`messagebox-core-architecture.md`](./messagebox-core-architecture.md) | Core messaging contract — Steward subscribes to `proposal.*` through MessageBox |
| [`message-semantic-taxonomy.md`](./message-semantic-taxonomy.md) | Semantic message roles — Steward uses Proposal and kg.mutation.* families |
| [`transport-abstraction-spec.md`](./transport-abstraction-spec.md) | Transport/ledger provider abstraction |

> **Implementation plan:** [`IMPLEMENTATION_PLANS/proposed/messagebox-mcp-steward-v0115.md`](../IMPLEMENTATION_PLANS/proposed/messagebox-mcp-steward-v0115.md)
