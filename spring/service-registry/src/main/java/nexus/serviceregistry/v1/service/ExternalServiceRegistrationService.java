...
import nexus.serviceregistry.v1.entity.ServiceConfiguration;
import nexus.serviceregistry.v1.entity.ServiceType;
import nexus.serviceregistry.v1.repository.FrameworkRepository;
import nexus.serviceregistry.v1.repository.ServiceConfigurationRepository;
...
public class ExternalServiceRegistrationService {
    ...
    @Transactional
    public nexus.serviceregistry.v1.entity.Service registerExternalService(
        ...
        nexus.serviceregistry.v1.entity.Service service = serviceRepository
                .findByName(registration.getServiceName())
                .orElse(new nexus.serviceregistry.v1.entity.Service());
    ...
    private void storeDependencies(nexus.serviceregistry.v1.entity.Service service,
    ...
    private void storeOperations(nexus.serviceregistry.v1.entity.Service service,
    ...
    private void storeMetadata(nexus.serviceregistry.v1.entity.Service service,
    ...
    private void storeHostedServices(nexus.serviceregistry.v1.entity.Service service,
    ...
    public boolean updateHeartbeat(String serviceName) {
        ...
        Optional<nexus.serviceregistry.v1.entity.Service> serviceOpt = serviceRepository
                .findByName(serviceName);

        if (serviceOpt.isPresent()) {
            nexus.serviceregistry.v1.entity.Service service = serviceOpt.get();
    ...
    public List<nexus.serviceregistry.v1.entity.Service> getAllActiveServices() {
        return serviceRepository.findByStatus("ACTIVE");
    }

    public Optional<nexus.serviceregistry.v1.entity.Service> findServiceByOperation(String operation) {
    ...
    public List<Map<String, Object>> getAllServicesWithHosted() {
        ...
        List<nexus.serviceregistry.v1.entity.Service> services = serviceRepository.findByStatus("ACTIVE");
        List<Map<String, Object>> result = new java.util.ArrayList<>();

        for (nexus.serviceregistry.v1.entity.Service service : services) {
