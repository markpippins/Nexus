...
class ServiceControllerV0Test {
    ...
    void getServiceByName_Found() {
        when(repository.findByName("Test Service")).thenReturn(Optional.of(testService));

        ResponseEntity<Service> response = controller.getServiceByName("Test Service");
    ...
    void getServiceByName_NotFound() {
        ...
        ResponseEntity<Service> response = controller.getServiceByName("Nonexistent");
    ...
    void getServiceDependencies() {
        ResponseEntity<List<Service>> response = controller.getServiceDependencies(1L);
    ...
    void getServiceDependents() {
        ResponseEntity<List<Service>> response = controller.getServiceDependents("1");
    ...
    void updateService_Success() {
        ...
        ResponseEntity<Service> response = controller.updateService(1L, updatedService);
