...
public class InferenceService {
    ...
    private static ChatModel openAi(String endpointUrl, String apiKey, String modelId) {
        ...
        System.err.println("[losm-diag] openAi() entry: ep=" + endpointUrl
                + " keySet=" + (key != null && !key.isBlank()) + " model=" + modelId);
        var clientBuilder = com.openai.client.okhttp.OpenAIOkHttpClient.builder();
        System.err.println("[losm-diag] builder class = " + clientBuilder.getClass().getName());
        ...
        try {
            ...
            System.err.println("[losm-diag] client build FAILED: " + t);
            t.printStackTrace();
            throw t;
        }
        System.err.println("[losm-diag] client built OK: " + client.getClass().getName());
