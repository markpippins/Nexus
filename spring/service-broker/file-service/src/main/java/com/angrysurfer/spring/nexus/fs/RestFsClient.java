...
import com.angrysurfer.spring.nexus.fs.api.FsItem;
import com.angrysurfer.spring.nexus.fs.api.FsListResponse;

import restfsservice.FsOperationResponse;
...
public class RestFsClient {
    ...
    public FsListResponse listFiles(String alias, List<String> path) {
        ...
        restfsservice.FsListResponse generatedResponse = client.listFiles(request);
    ...
    public Map<String, Object> changeDirectory(String alias, List<String> path) {
        ...
        restfsservice.FsListResponse response = client.changeDirectory(request);
     ...
     */
    private FsListResponse convertToApiListResponse(restfsservice.FsListResponse generated) {
        if (generated == null) {
            return null;
        }
     ...
     */
    private FsItem convertToApiFsItem(restfsservice.FsItem generated) {
        if (generated == null) {
            return null;
        }
     ...
     */
    private Map<String, Object> toMap(restfsservice.FsListResponse response) {
     ...
     */
    private List<restfsservice.FsItemReference> convertItems(List<Map<String, Object>> items) {
        ...
        return items.stream()
            .map(item -> {
                ...
                restfsservice.FsItemReferenceType type = "folder".equalsIgnoreCase(typeStr) ?
                    restfsservice.FsItemReferenceType.FOLDER :
                    restfsservice.FsItemReferenceType.FILE;
                return new restfsservice.FsItemReference(
