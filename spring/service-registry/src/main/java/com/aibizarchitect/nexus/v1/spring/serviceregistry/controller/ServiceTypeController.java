...
public class ServiceTypeController {
    ...
    @GetMapping
    public ResponseEntity<com.aibizarchitect.nexus.v1.dto.PagedResponse<ServiceType>> getAll(org.springframework.data.domain.Pageable pageable) {
        ...
        return ResponseEntity.ok(com.aibizarchitect.nexus.v1.spring.serviceregistry.dto.SpringPagedResponse.fromPage(serviceTypes));
    }
