...
@Setter
@Entity
@jakarta.persistence.Table(name = "qbe_query", schema = "shrapnel")
public class Query {
	...
	private Set< com.aibizarchitect.nexus.shrapnel.model.sqlgen.Column > columns = new HashSet<>();
	...
	private String getTableName(com.aibizarchitect.nexus.shrapnel.model.sqlgen.Column column, boolean prefix) {
