...
|---|---|
| [`LOWERING_PASS.md`](./LOWERING_PASS.md) | Phase 1.5 — transforms WorkRequestGraph into ExecutionGraph |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | Four-dimension validation (Static S1–S10, Runtime R1–R10, AEI, HAEC) |
| [`PHASE2_EXECUTION_RUNTIME.md`](./PHASE2_EXECUTION_RUNTIME.md) | Interprets frozen ExecutionGraph as a program via Scheduler |
| [`WORKREQUEST_SPEC.md`](./WORKREQUEST_SPEC.md) | Input IR — WorkRequest is lowered into ExecutionGraph |
| [`COMPILER_ARCHITECTURE.md`](./COMPILER_ARCHITECTURE.md) | Four-phase architecture overview |
| [`DISTRIBUTED_SCHEDULER.md`](./DISTRIBUTED_SCHEDULER.md) | Multi-node scheduler consuming ExecutionGraph |
| [`REPLAY_ENGINE.md`](./REPLAY_ENGINE.md) | Temporal reconstruction from ExecutionGraph + EventLog |
