/**
 * semantics_tables.ts — registry of the 17 semantics.* tables, ported
 * verbatim from typescript/semantics-srv/src/tables.ts (Wave 2.2 re-home).
 *
...
export const TABLES: TableMeta[] = [
  ...
  },
  {
    ...
    label: 'representation identity (how a form expresses its concept identity)',
    idType: 'uuid',
    idAuto: true,
    smallintCols: [],
    jsonbCols: [],
  ...
  },
  {
    ...
    note: 'T02 Phase 1. canonical_asset_id is the durable business key (compound asset:<platform>:<ns>:<key>); partial unique index on active rows.',
  },
  {
