...
|---|---|
| [`messagebox-core-architecture.md`](./messagebox-core-architecture.md) | Core messaging architecture affected by hang cycle |
| [`../conduit-code-assessment.md`](../conduit-code-assessment.md) | Prior assessment of conduit FS/DB tensions |
| [`../conduit-db-conversion.md`](../conduit-db-conversion.md) | SQLite → PostgreSQL migration spec |
| [`../IMPLEMENTATION_PLANS/pending/model-integration-and-fallback-test-v0130.md`](../IMPLEMENTATION_PLANS/pending/model-integration-and-fallback-test-v0130.md) | E2E test for model fallback behavior |
