          ...
          <div class="lg:col-span-2 space-y-4">
            <div class="app-panel p-4">
              ...
              <div *ngIf="wr()!.intent || wr()!.description" class="space-y-3">
                <div *ngIf="wr()!.intent">
                  <p class="text-sm font-medium text-gray-500 uppercase">Intent</p>
            ...
            <div *ngIf="wr()!.context" class="app-panel p-4">
              ...
              <pre class="bg-gray-50 p-3 rounded text-sm font-mono overflow-auto max-h-64 whitespace-pre-wrap">{{ formatJson(wr()!.context) }}</pre>
            </div>

            <div *ngIf="wr()!.constraints" class="app-panel p-4">
              <h2 class="text-sm font-semibold text-gray-900 mb-2">Constraints</h2>
              <pre class="bg-gray-50 p-3 rounded text-sm font-mono overflow-auto max-h-64 whitespace-pre-wrap">{{ formatJson(wr()!.constraints) }}</pre>
            </div>
          </div>
