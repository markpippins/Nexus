...
|---|---|
| [`peb-mcp-spec.md`](./peb-mcp-spec.md) | Architecture-level PEB spec — this document derives from it (v2, post-critique) |
| [`cognitive-integrity-rule-system.md`](./cognitive-integrity-rule-system.md) | CIRS — governs PEB governance rules (CIRS-MED, CIRS-SPoE, CIRS-CORE) |
| [`atten-spec.md`](./atten-spec.md) | Atten — PEB validates committed canonical state transitions |
| [`VALIDATOR_SPEC.md`](./VALIDATOR_SPEC.md) | ExecutionGraph Validator — PEB validates transitions at a different layer |
